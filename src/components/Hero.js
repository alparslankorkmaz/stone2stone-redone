      ...
      <div className="mb-20">
        ...
        <div className="relative flex overflow-x-hidden">
          <div className="animate-marquee grid grid-cols-4 mt-14">
            <div className="mx-1 lg:mx-4 col-span-1 rounded-xl overflow-hidden">
          ...
          <div className="absolute top-0 animate-marquee2 grid grid-cols-4 mt-14">
            <div className="mx-1 lg:mx-4 col-span-1 rounded-xl overflow-hidden">
              <img src="/gifs/1_AdobeExpress.gif" alt="short clip" />
            </div>
            <div className="mx-1 lg:mx-4 col-span-1 rounded-xl overflow-hidden">
        ...
        <div className="relative flex overflow-x-hidden">
          ...
          <div className="absolute top-0 animate-fastmarquee2 grid grid-cols-4 mt-7">
            <div className="mx-1 lg:mx-4 col-span-1 rounded-xl overflow-hidden">
              <img src="/gifs/5_AdobeExpress.gif" alt="short clip" />
            </div>
            <div className="mx-1 lg:mx-4 col-span-1 rounded-xl overflow-hidden">
